        ...
        <main>
                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                  <div className="lg:py-24">
                    ...
                    >
                      ...
                      <span className="ml-4 text-sm">Visit our landing page</span>
          ...
          <div className="relative bg-gray-50 pt-16 sm:pt-24 lg:pt-32">
            <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
              <div>
                <h2 className="text-lg font-semibold text-cyan-600">Go4FX TRADING</h2>
                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                Economists refer to a system or network that allows trade as a market.
                </p>
                <p className="mx-auto mt-5 max-w-prose text-xl text-gray-500">
                Trade originated from human communication in prehistoric times. Trading was the main facility of prehistoric people,[citation needed] who exchanged goods and services from each other in a gift economy before the innovation of modern-day currency.
                </p>
              </div>
              <div className="mt-12 -mb-10 sm:-mb-24 lg:-mb-40">
                <img
                  className=" flex-auto rounded-lg shadow-xl ring-1 ring-black ring-opacity-5"
                  src="https://images.unsplash.com/photo-1639917714192-557a6143f788?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTR8fHRyYWRlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                  alt=""
                />
              </div>
            </div>
                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:h-full lg:p-0">
                  <div className="aspect-w-10 aspect-h-6 overflow-hidden rounded-xl shadow-xl sm:aspect-w-16 sm:aspect-h-7 lg:aspect-none lg:h-full">
                    <img
                      ...
                      src="https://images.unsplash.com/photo-1642543348745-03b1219733d9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fHRyYWRlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                      alt=""
                    />
                  </div>
                </div>
                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
                  <blockquote>
                    <div>
                      ...
                      Every technical and financial information you would like to know about the stock - Open, high, low, close, 52 week high, circuit limit, Market depth, consolidated and standalone data of key stats like sales, EBITDA, PAT, Market Cap, Margin Ratios, Share holding pattern etc.
                      </p>
                    </div>
                    <footer className="mt-6">
                      <p className="text-base font-medium text-white">GO4FX</p>
                      <p className="text-base font-medium text-cyan-100">CEO at GO4FX</p>
                    </footer>
                  </blockquote>
                </div>
              </div>
...
With this online trading app it is not just easy to login and trade but if you get stuck logging in, it is equally easy to get help. With our login help feature you can easily unblock your account, change your password, know your Year of birth or user ID in case you forget it.
                </p>
                <div className="mt-8">
          ...
          <div className="mx-auto max-w-md px-4 pt-12 sm:max-w-7xl sm:px-6 lg:px-8 lg:pt-16">
            ...
            <div className="mt-12 border-t border-gray-200 py-8">
              <p className="text-base text-gray-400 xl:text-center">
                &copy; 2022 GO4FX, Inc. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
